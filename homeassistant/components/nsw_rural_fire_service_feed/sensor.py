"""Feed Entity Manager Sensor support for NSW Rural Fire Service Feed."""
import logging
...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    sensor = NswRuralFireServiceFeedSensor(
...
class NswRuralFireServiceFeedSensor(Entity):
    """This is a status sensor for the NSW Rural Fire Service integration."""
    ...
    async def async_added_to_hass(self):
        ...
        self._remove_signal_status = async_dispatcher_connect(
            self.hass,
            f"nsw_rural_fire_service_feed_status_{self._config_entry_id}",
    ...
    def should_poll(self):
        """No polling needed for NSW Rural Fire Service status sensor."""
        return False
    ...
    def name(self) -> Optional[str]:
        ...
        return f"NSW Rural Fire Service ({self._config_title})"
